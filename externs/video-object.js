/**
 */
class LGVideoObject extends HTMLElement {
	/**
	 */
	constructor() {
		super();
	 ...
	 * non-silently obtain the rights for the content item currently being played for which * this DRM error is
	 * generated, in cases whereby the rightsIssuerURL is known. If different URLs are retrieved from the stream
	 * and the metadata, then the conflict resolution is implementation-dependent.
	 *
